...
async function main() {
  const v2 = new ethers.Contract(process.env.PROXY_ADDRESS || "0x7a41abE5B170085fDe9d4e0a3BaD47A70bAC52bc", [
  ...
  const profile = await v2.getRiskProfile("0xe950dc316b836e4eefb8308bf32bf7c72a1358ff");
