...
&#125;</code></pre>
        ...
        <div className="blog-nav reveal">
          <Link href="/cn/blog" prefetch={false}>← 全部文章</Link>
          <Link href="/cn/blog/why-on-chain-compliance" prefetch={false}>下一篇：为何链上 →</Link>
        </div>
      </div>
    </article>
  
      <BlogNav back="返回博客" prevLabel="上一篇" nextLabel="下一篇" prev={ { href: "/blog/hong-kong-stablecoin-license", title: "" } } next={ { href: "/blog/why-on-chain-compliance", title: "为何链上：API 合规模式的终结" } } />
    </>
  );
}
