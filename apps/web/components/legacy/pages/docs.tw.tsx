...
<div className="docs-layout">
    ...
    <main className="docs-content">
      <h1>文件</h1>
      <p className="docs-lead">將鏈上合規集成到您的協議所需的一切。</p>
...
&#125;</code></pre>
      ...
      <div className="docs-concept-grid">
        ...
        <div className="docs-concept">
          <h4>風險等級</h4>
          <p>五個級別：UNKNOWN、LOW、MEDIUM、HIGH、CRITICAL。每個級別觸發不同的執行操作。</p>
        </div>
        <div className="docs-concept">
          <h4>策略引擎</h4>
          <p>每個資產可配置規則：最大交易金額、日限額、制裁地址攔截、KYC 要求。</p>
        </div>
        <div className="docs-concept">
          <h4>隔離金庫</h4>
      ...
      <div style={{ "background": "var(--bg-card)", "border": "1px solid var(--border)", "borderRadius": "var(--radius-md)", "padding": "8px" }}>
        <div className="docs-arch-item">
          ...
          <div>
            ...
            <p>鏈上存儲 20,000+ 風險檔案、制裁名單和實體標籤。</p>
          </div>
        </div>
        <div className="docs-arch-item">
        ...
        <div className="docs-arch-item">
          ...
          <div>
            ...
            <p>內置合規鉤子的 ERC20 示例。繼承用於您自己的代幣。</p>
          </div>
        </div>
        <div className="docs-arch-item">
          <div className="docs-arch-icon">&#128202;</div>
