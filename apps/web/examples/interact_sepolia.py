#!/usr/bin/env python3
"""
FidesOrigin 智能合约交互示例 (Python web3.py)

使用方法:
    pip install web3 python-dotenv
    python examples/interact_sepolia.py
...
class FidesOriginClient:
    ...
    def __init__(self, private_key: str = None, rpc_url: str = None):
        ...
        # 初始化 Web3
        self.rpc_url = rpc_url or self.SEPOLIA_RPC_URL
        ...
        print(f"💰 Balance: {self.get_eth_balance():.6f} ETH")
    ...
    def _load_contracts(self):
        ...
        try:
            deployment_path = os.path.join(
                os.path.dirname(__file__), '..', 'deployments', 'sepolia.json'
            )
    ...
    def send_eth(self, to: str, amount_eth: float) -> str:
        ...
        print(f"📤 ETH transfer sent: {tx_hash.hex()}")
...
def main():
    """示例用法"""
    print("=" * 70)
    print("🚀 FidesOrigin Python SDK Demo")
    print("=" * 70)
    ...
    print("💰 代币余额")
    print("-" * 70)
    print(f"ETH Balance: {client.get_eth_balance():.6f} ETH")
