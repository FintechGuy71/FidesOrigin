...
export type RiskFlag = 'sanctions' | 'fraud' | 'phishing' | 'hack' | 'mixer' | 'darknet' | 'scam' | 'high_risk_exchange' | 'ransomware' | 'terrorism_financing' | 'money_laundering' | 'tornado_cash' | 'suspicious_activity' | 'peeling_chain' | 'layering';
