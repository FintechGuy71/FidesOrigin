...
async function main() {
  ...
  const deploymentInfo = {
    ...
    abi: JSON.parse(TestUSD.interface.formatJson()),
  };
  ...
  console.log('  Total Supply:', hre.ethers.formatUnits(info.totalSupply, 18), 'TUSD');
  console.log('  VIP Count:', info.vipCount.toString());
  console.log('  Grey List Count:', info.greyCount.toString());
  console.log('  Black List Count:', info.blackCount.toString());
  console.log('  Paused:', info.paused);
  console.log('  Timelock Delay:', info.timelockDelay_.toString(), 'seconds');
  console.log('  Required Signatures:', info.requiredSigs.toString());
  console.log('  Signer Count:', info.signerCount_.toString());
